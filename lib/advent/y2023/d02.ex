defmodule Advent.Y2023.D02 do
  ...
  # Could I have done this without NimbleParsec? Absolutely. However, I wanted to
  # try the library out.
  ...
  #
  # Here's a regex that will more or less do the same thing (would need to adapt
  # to list position rather than labels)
  ...
  defp parse_input(input) do
    ...
    |> Stream.map(&Advent.Y2023.D02.games_record/1)
